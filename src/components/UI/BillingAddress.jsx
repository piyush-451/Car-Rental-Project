...
function BillingAddress({token}) {

  const [addresses,setAddressess] = useState([]);
  const endpoint = 'http://127.0.0.1:5001/car-rental-apis/us-central1/app/api/getAllAddresses';
  const saveAddressEndpoint = 'http://127.0.0.1:5001/car-rental-apis/us-central1/app/api/addAddress';
